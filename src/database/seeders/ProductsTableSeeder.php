    ...
    public function run()
    {
        DB::table('products')->insert([
            [
                'name' => 'キウイ',
                'price' => 800,
                'image' => Storage::url('products/kiwi.png'),
            ...
            [
                'name' => 'ストロベリー',
                'price' => 1200,
                'image' => Storage::url('products/strawberry.png'),
            ...
            [
                'name' => 'オレンジ',
                'price' => 850,
                'image' => Storage::url('products/orange.png'),
            ...
            [
                'name' => 'スイカ',
                'price' => 700,
                'image' => Storage::url('products/watermelon.png'),
            ...
            [
                'name' => 'ピーチ',
                'price' => 1000,
                'image' => Storage::url('products/peach.png'),
            ...
            [
                'name' => 'シャインマスカット',
                'price' => 1400,
                'image' => Storage::url('products/muscat.png'),
            ...
            [
                'name' => 'パイナップル',
                'price' => 800,
                'image' => Storage::url('products/pineapple.png'),
            ...
            [
                'name' => 'ブドウ',
                'price' => 1100,
                'image' => Storage::url('products/grapes.png'),
            ...
            [
                'name' => 'バナナ',
                'price' => 600,
                'image' => Storage::url('products/banana.png'),
            ...
            [
                'name' => 'メロン',
                'price' => 900,
                'image' => Storage::url('products/melon.png'),
